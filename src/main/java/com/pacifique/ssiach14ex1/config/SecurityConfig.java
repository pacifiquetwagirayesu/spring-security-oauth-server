...
public class SecurityConfig {
    ...
    public SecurityFilterChain asFilterChain(HttpSecurity http)
        ...
        HttpSecurity securityMatcher = http.securityMatcher(authorizationServerConfigurer.getEndpointsMatcher());
        securityMatcher.with(authorizationServerConfigurer,c->
